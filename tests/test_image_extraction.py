...
class TestImageProcessor:
    ...
    def test_save_cropped_images_without_attributes(self, test_images_dir, temp_output_dir):
    ...
    def test_save_cropped_images_with_attributes(self, test_images_dir, temp_output_dir):
        ...
        attributes_list = [
            {
                ...
                'comments': 'Test extraction with EXIF data'
            }
        ]
        ...
        try:
            ...
            assert exif_dict['Exif'][piexif.ExifIFD.DateTimeOriginal] == expected_date.encode()
            
            # Check comment
            assert b'Test extraction with EXIF data' in exif_dict['Exif'][piexif.ExifIFD.UserComment]
...
class TestEXIFHandling:
    ...
    def test_save_image_with_exif_date_conversion(self, temp_output_dir, test_image):
        ...
        assert exif_dict['Exif'][piexif.ExifIFD.DateTimeOriginal] == expected_datetime.encode()
        assert exif_dict['Exif'][piexif.ExifIFD.DateTimeDigitized] == expected_datetime.encode()
