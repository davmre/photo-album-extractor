...
REFINEMENT_STRATEGIES: dict[str, Callable[..., QuadArray]] = {
    ...
    "Original (multiscale)": (
        lambda image, corner_points, debug_dir=None: refine_bounding_box_multiscale(
            image, corner_points, enforce_parallel_sides=True, debug_dir=debug_dir
        )
    ),
    "Original (multiscale, independent sides)": (
        lambda image, corner_points, debug_dir=None: refine_bounding_box_multiscale(
            image, corner_points, enforce_parallel_sides=False, debug_dir=debug_dir
        )
    ),
    "Strips (native res)": (
        lambda image, corner_points, debug_dir=None: refine_bounding_box_strips(
            image, corner_points, enforce_parallel_sides=True, debug_dir=debug_dir
        )
    ),
    ...
    "Strips (multiscale)": (
        lambda image,
        corner_points,
        debug_dir=None: refine_bounding_box_strips_multiscale(
            image, corner_points, enforce_parallel_sides=True, debug_dir=debug_dir
        )
    ),
}
